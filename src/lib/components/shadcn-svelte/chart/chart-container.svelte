...
<style>
  :global([data-slot="chart"] .lc-tooltip-container[data-variant="default"]) {
    background-color: var(--popover) !important;
    color: var(--popover-foreground) !important;
    border: 1px solid color-mix(in oklab, var(--border) 70%, transparent);
  }

  :global([data-slot="chart"] .lc-tooltip-container[data-variant="default"] .label) {
    color: color-mix(in oklab, var(--popover-foreground) 75%, transparent) !important;
  }
</style>
